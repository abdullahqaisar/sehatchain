...
export const lungSelect = {
  ...
  YELLOW_FINGERS: [
    {
      value: 0,
      label: "No Yellow Fingers",
    },
    {
      value: 1,
      label: "Yellow Fingers Detected",
    },
  ],
  PEER_PRESSURE: [
    {
      value: 0,
      label: "No Peer Pressure",
    },
    {
      value: 1,
      label: "Peer Pressure Detected",
    },
  ],
  CHRONIC_DISEASE: [
    {
      value: 0,
      label: "No Chronic Lung Disease",
    },
    {
      value: 1,
      label: "Chronic Lung Disease Detected",
    },
  ],
  FATIGUE: [
    {
